...
namespace MvcClienteApiCrudDepartamentos.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        {
            await this.service.InsertDepartamentoAsync(dept.DeptNo, dept.Nombre, dept.Localidad);
            return RedirectToAction("Index");
        }
        ...
        {
            await this.service.UpdateDepartamentoAsync(dept.DeptNo,dept.Nombre,dept.Localidad);
            return RedirectToAction("Index");
        }
